...
namespace Neural
{
  class Loss {
    public:
      ...
      virtual Eigen::MatrixXd ComputePrime(Eigen::MatrixXd y_true, Eigen::MatrixXd y_pred) = 0;
  };
  ...
  class Mse : public Loss {
    public:
      ...
      virtual Eigen::MatrixXd ComputePrime(Eigen::MatrixXd y_true, Eigen::MatrixXd y_pred) {
